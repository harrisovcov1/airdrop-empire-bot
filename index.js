...
async function getOrCreateUserFromInitData(req) {
  ...
  const username = parsed.user.username ? String(parsed.user.username).toLowerCase() : null;
  const firstName = parsed.user.first_name ? String(parsed.user.first_name) : null;
  const lastName = parsed.user.last_name ? String(parsed.user.last_name) : null;
  const photoUrl = parsed.user.photo_url ? String(parsed.user.photo_url) : null;
