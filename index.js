      ...
      if (amountMinor != null) {
        ...
        if (coinsGranted && Number.isFinite(coinsGranted) && coinsGranted > 0 && providerPaymentId) {
          ...
          await withTransaction(async (client) => {
            ...
            // If this Coinbase purchase is the Starter Bundle, permanently mark the starter offer as purchased.
            try {
              ...
              console.warn("Failed to mark starter_offer_purchased from Coinbase webhook", e?.message || e);
            }
...
app.post("/api/task", async (req, res) => {
  try {
    ...
    user = upd.rows[0];
    // Starter Bundle onboarding: if user just became eligible for the starter offer,
    // start a 7-day window the first time they successfully claim the daily bonus.
