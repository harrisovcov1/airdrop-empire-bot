...
async function ensureSchema(client) {
  ...
  await client.query(`
    ...
    ADD COLUMN IF NOT EXISTS referrals BIGINT DEFAULT 0,
...
async function getOrCreateUserFromInitData(req) {
  ...
  const startParam = (req.body && (req.body.start_param || req.body.startParam)) || req.query.start_param || req.query.startParam || data.start_param || null;
