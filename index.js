...
// ALIGNMENT DEBUG: version endpoint
const API_VERSION = "ALIGNCHECK-20251225-024828Z";
console.log("[VERSION]", API_VERSION, "boot", new Date().toISOString());
app.get("/api/version", (req, res) => res.json({ ok: true, version: API_VERSION, time: new Date().toISOString() }));
app.get("/version", (req, res) => res.json({ ok: true, version: API_VERSION, time: new Date().toISOString() }));
